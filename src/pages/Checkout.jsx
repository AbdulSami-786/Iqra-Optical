...
//                   <div className="flex-1 min-w-0">
//                     <p className="text-xs font-semibold text-ink line-clamp-1">{item.name}</p>
//                     <p className="text-[11px] text-gray-500">Rs. {itemPrice.toLocaleString()}</p>
//                     {item.prescription && (
//                       <p className="text-[10px] text-gray-400">Lens: {item.prescription.lensLabel}</p>
//                     )}
//                   </div>
//                   <span className="text-xs font-bold text-ink">Rs. {totalItemPrice.toLocaleString()}</span>
//                 </div>
//               );
//             })}
//           </div>
